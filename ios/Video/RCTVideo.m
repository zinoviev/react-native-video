...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context
{
    ...
    if (object == _playerItem) {
        ...
        // IGOR: I add condition to check if observers is up. I don't know if it was bug in
        // react-native-library or what, but sometimes we get crash, when observer was called
        // and object was already deallocated
    } else if ([super respondsToSelector:@selector(observeValueForKeyPath:ofObject:change:context:)] && self->_playerItemObserversSet == YES) {
